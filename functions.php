...
function lorainccc_microsite_setup() {
	...
	register_nav_menus(
		array(
			'primary' => esc_html__( 'Primary', 'lorainccc-microsite' ),
			'left-nav' => esc_html__( 'Left Nav', 'lorainccc-microsite' ),
			'footer-quicklinks-nav' => esc_html__( 'Footer Quicklinks', 'lorainccc-microsite' ),
			'footer-campus-location-nav' => esc_html__( 'Footer Campus Locations', 'lorainccc-microsite' ),
			'mobile-primary' => esc_html__( 'Mobile Primary Menu', 'lorainccc-microsite' ),
			'header-shortcuts' => esc_html__( 'Header Shortcuts Menu', 'lorainccc-microsite' ),
			'mobile-header-shortcuts' => esc_html__( 'Mobile Header Shortcuts Menu', 'lorainccc-microsite' ),
			'page-top-buttons' => esc_html__( 'Page Top Buttons Menu', 'lorainccc-microsite' ),
			'page-top-second-menu' => esc_html__( 'Page Top Secondary Menu', 'lorainccc-microsite' ),
      		'primary-microsite' => esc_html__( 'Primary Microsite', 'lorainccc-microsite' ),
			'leftnav-microsite' => esc_html__( 'Left Nav Microsite', 'lorainccc-microsite'),
			'footer-quicklinks-microsite' => esc_html__( 'Footer Quicklinks Microsite', 'lorainccc-microsite' ),
		)
	);
